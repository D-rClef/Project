/* Код немного сломался где-то на определении размеров a и b (шифротекста).
Я всё починю и, скорее всего, сразу с модификацией для использования действительно длинных чисел. 
После этого реализую режим подписи. */
